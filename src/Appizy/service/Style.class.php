...
class style {
  ...
  // Nom du style
  var $name;
  // Array contenant les donnŽes de style pour le texte
  var $styles;
  ...
  function printStyle() {
		...
		// Certains styles n'ont pas de propriŽtŽs
		if(is_array($prop)) {
  ...
  /*
   Ajoute des styles ˆ un objet dŽjˆ existant
  */
  ...
  /*
   Ajoute des styles ODS ˆ un objet
  */
